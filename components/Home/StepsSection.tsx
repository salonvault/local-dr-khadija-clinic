          ...
          <div className="lg:sticky lg:top-24">
            <div className="relative min-h-[420px] overflow-hidden rounded-[8px] border border-[rgba(107,73,50,0.14)] bg-white shadow-[var(--shadow-lift)] lg:h-[min(620px,calc(100vh-7rem))] lg:min-h-0">
              <Image
                ...
                quality={100}
                alt="Patient receiving a professional skin treatment at Doctor Khadija Clinic"
                fill
              ...
              <div className="absolute bottom-6 left-6 right-6 text-white">
                <p className="text-[10px] font-extrabold uppercase tracking-[0.08em] text-white/78">The Doctor Khadija care journey</p>
