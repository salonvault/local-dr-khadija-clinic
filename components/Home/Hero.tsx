  ...
  return (
    <div className="relative h-[104px] w-[104px] shrink-0 overflow-hidden rounded-[14px] bg-white/40 shadow-[inset_0_1px_0_rgba(255,255,255,0.42)] md:h-[118px] md:w-[118px]">
      <Image
        ...
        alt="Clinical facial treatment at Doctor Khadija Clinic in Gujranwala"
        fill
        sizes="168px"
        ...
        <div className="relative z-30 flex min-h-[calc(100vh-4px)] flex-col px-5 pb-6 pt-24 sm:px-7 md:px-12 md:pt-28 lg:grid lg:grid-rows-[auto_1fr_auto] lg:px-16 lg:pb-9 lg:pt-36">
          <div className="max-w-[690px]">
            <p className="hero-kicker">
              ...
              Skin, laser & aesthetic care in Gujranwala
            </p>

            <h1 className="heading-h1 hero-title mt-5">
              Your Skin Deserves
              <span className="hero-title-accent block">Expert Attention.</span>
            </h1>
            ...
            <p className="hero-copy mt-6">
              Personalised care for acne, pigmentation, hair loss, laser treatments, and aesthetic concerns—with dental services available under one roof.
            </p>

            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              <a href="https://wa.me/923124039999" className="hero-cta bg-[#c77417] text-white shadow-[0_18px_38px_rgba(76,34,6,0.26)] transition hover:bg-[#a85f13]">
                Book Appointment
                <ArrowBadge />
              </a>
          ...
          <div className="relative z-10 mt-[-46px] flex items-center gap-3 rounded-[14px] border border-white/16 bg-[#9b5919]/64 p-4 shadow-[0_22px_54px_rgba(49,20,4,0.24)] backdrop-blur-xl md:max-w-[520px] lg:hidden">
            <MiniImage />
            <div>
              <p className="offer-title text-white">Meet Dr. Khadija</p>
              <p className="offer-subtitle mt-1 text-white">Care With Clarity</p>
              <p className="offer-note mt-2 max-w-[190px] text-white/62">
                A focused consultation before your treatment plan begins.
              </p>
            </div>
          </div>
          ...
          <a id="book" href="https://wa.me/923124039999" className="sr-only">
            Book Appointment
          </a>
        </div>
      </div>
